...
title_align = 'left'
title_text = 'Metro Atlanta Observed Rent Index'

# paragraph text
st.markdown(
    f"<p style='color:{title_color}; font-size:{title_font_size}px; font-weight:{title_font_weight}; font-style:{title_font_style}; display:in-line; text-align:{title_align};'><b>{title_text}</b>", unsafe_allow_html=True)


# Set RGB color ramp for the mapper function
lightest_color = "#bcbddc"
darkest_color = "#4a1486"
num_steps = 6
...
def draw_map():
    ...
    tooltip = {
        "html": "Zillow observed rent index: <b>{data_formatted}</b><hr style='margin: 10px auto; opacity:0.5; border-top: 2px solid white; width:85%'>\
                    ZIP: {zip_code} <br>\
...
max_text = 'Highest Rent:'
median_text = 'Median Rent:'
min_text = 'Lowest Rent:'
