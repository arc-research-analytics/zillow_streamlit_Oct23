...
title_align = 'left'
title_text = 'Historic Rent Indices by ZIP Code'
...
# read in data
df = pd.read_csv('Processed_data/historic_ZORI.csv')
...
# KPI section---------------------------------------------------
df_summary = pd.read_csv('Processed_data/historic_ZORI_summary.csv')
