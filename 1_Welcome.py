...
# paragraph text
text_1 = 'This desktop app is built to explore Zillow\'s home value and rent index datasets. Browse the five visuals via the left-hand sidebar navigation menu. All data has been downloaded to the ZIP code level and is current as of November 2023. Read more about Zillow\'s home value methodology <a href="https://www.zillow.com/research/methodology-neural-zhvi-32128/" style="' + \
